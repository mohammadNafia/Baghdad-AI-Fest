...
import { Save, RefreshCw, Search, ChevronDown, ChevronRight, Globe, Languages } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          ...
          <p className={`text-sm mt-1 ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'}`}>
            {lang === 'ar' ? 'تحرير محتوى الموقع بالعربية والإنجليزية' : 'Edit site content in English and Arabic'}
          </p>
        </div>
