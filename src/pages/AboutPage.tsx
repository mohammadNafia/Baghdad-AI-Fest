...
const CONTENT = {
  en: {
    ...
    intro1_bold: 'Baghdad.',
    intro1_rest: ' The name itself evokes a history of profound knowledge. During the Golden Age, the House of Wisdom attracted scholars from across the known world to translate, innovate, and debate.',
    intro2: 'The Baghdad AI Summit 2026 is the spiritual successor to that legacy. We are not just hosting a conference; we are building an ecosystem. By connecting local talent with global experts, we aim to position Iraq as a pivotal node in the global AI network.',
    vision_title: 'Vision',
  ...
  ar: {
    ...
    intro1_bold: 'بغداد.',
    intro1_rest: ' الاسم الذي يستحضر تاريخاً عريقاً من المعرفة العميقة. في العصر الذهبي، استقطب بيت الحكمة علماء من أصقاع العالم لترجمة العلوم والابتكار والنقاش.',
    intro2: 'قمة بغداد للذكاء الاصطناعي 2026 هي الامتداد الروحي لذلك الإرث. نحن لا نستضيف مؤتمراً فحسب، بل نبني منظومة متكاملة. من خلال ربط المواهب المحلية بالخبراء العالميين، نسعى لوضع العراق في مكانة محورية ضمن الشبكة العالمية للذكاء الاصطناعي.',
    vision_title: 'الرؤية',
